...
<div class="">
    ...
    <tr>
        ...
        <tbody>
            <%
 st = conexion.prepareStatement("SELECT p.id_persona,p.nombre_persona," +
 "p.edad_persona,p.sexo_persona,p.id_ocupacion,p.fecha_nac, " +
 "p.usuario, o.ocupacion FROM persona p INNER JOIN ocupaciones o " +
 ...
 %>
        <tr>
            ...
            <td><button class="btn btn-danger"
                        onclick="alerta('<%=rs.getString("id_persona")%>')">
                Eliminar</button></td>
            <td><button class="btn btn-info"
                        onclick="modificar('<%=rs.getString("id_persona")%>',
                                ...
                                '<%=rs.getString("usuario")%>')"> Modificar
            </button>
            </td>
        </tr>
            <%
